...
const locationCoords: [number, number] = [
  -20.545735817532602, -47.42496940963758,
];
const address =
  "Avenida Doutor Severino Tostes Meirelles, 1660 – São Miguel, Franca – SP";
  ...
  return (
    <div className="localizacao-section">
      <div className="localizacao-container">
        ...
        >
          Estamos prontos para te receber. Visite nossa loja e conheça nossa
          frota de perto.
        </motion.p>
            ...
            <div className="info-section">
              ...
              <ul className="amenities-list">
                <li className="amenity-item">
                  <FaCar /> Estacionamento no local
                </li>
                <li className="amenity-item">
                  <FaWifi /> Wi-Fi para clientes
                </li>
              </ul>
            </div>
          </motion.div>
